<template>
    <footer>
      <div class="footer__logos">
        <h2 style="color : #fff">tasks manager</h2>
        <div class="mdlogo">
          <div>
          ...
          <div>
            <a href="https://www.instagram.com/belkadihassan99" class="instalogo">
              <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20">
              <path
                fill="currentColor"
      ...
      <div class="footer__nav">
        <router-link to = "/about" class="routerLinks">About Us</router-link>
        <router-link to = "/" class="routerLinks">home</router-link>
      </div>
      <div class="footer__request">
        <div>&copy; Tasks manager. All Rights Reserved</div>
      </div>
    </footer>
</template>
